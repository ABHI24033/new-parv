...
export function PersonalDetails({ formData, handleFieldChange, errors }) {
    return (
        <FormSectionCard
            ...
            description="Enter applicant and family details."
        >
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <FormSelect
                    ...
                    options={[
                        { label: "To start a new business", value: "To start a new business" },
                        { label: "For the growth of existing business", value: "For the growth of existing business" },
                    ]}
                />
                <FormInput
                    required
