    ...
    return (
        <Card className="rounded-2xl shadow-sm border-zinc-200 overflow-hidden">
            <CardHeader className="bg-zinc-50/50 border-b">
                ...
                <CardDescription>Comprehensive summary of your personal loan application.</CardDescription>
            </CardHeader>
            <CardContent className="p-6 space-y-8">
                ...
                <ReviewSection title="Employment Details" icon={Building2} onEdit={() => setStep(3)}>
                    <DataField label="Company Name" value={formData.current_company_name} />
                    <DataField label="Designation" value={formData.designation} />
                    <DataField label="Salary Bank" value={formData.salary_account_bank} />
                    <DataField label="Total Experience" value={formData.job_experience} />
                    <DataField label="Monthly Income" value={formData.monthly_income} />
                    <DataField
                        label="Office Address"
                        value={[formData.office_building_name, formData.office_street_name, formData.office_city, formData.office_district, formData.office_state, formData.office_pincode].filter(Boolean).join(", ")}
                        className="md:col-span-2 lg:col-span-3"
                    />
                </ReviewSection>

                <div className="space-y-4">
                    <ReviewSection title="Financial & Loan Details" icon={Briefcase} onEdit={() => setStep(4)}>
