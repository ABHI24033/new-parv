                ...
                <div className=" px-4 max-w-7xl mx-auto">
                    <div className="-mx-4 flex flex-wrap justify-between">
                        <div className="px-4 my-4 w-full xl:w-1/3">
                            ...
                            <p className="mt-1 text-slate-300 flex gap-2 items-center">
                                <Phone size={18} /> +91 7292800809
                            </p>
                            <p className="mt-1 text-slate-30 flex items-center gap-2">
                                <Clock size={18} />  WORKING HOURS- 10 AM to 6 PM ( Monday - Saturday)
                            </p>
                        </div>
                        ...
                        <div className="px-4 my-4 w-full sm:w-auto">
                            ...
                            <ul className="leading-8">
                                <li><Link href="/services/home-loan" className="hover:text-blue-400">Home Loan</Link></li>
                                <li><Link href="/services/persoanl-loan" className="hover:text-blue-400">Personal Loan</Link></li>
                                <li><Link href="/services/business-loan" className="hover:text-blue-400">Business Loan</Link></li>
                                <li><Link href="/services/vehicle-loan" className="hover:text-blue-400">Vehicle Loan</Link></li>
                                <li><Link href="/services/gold-loan" className="hover:text-blue-400">Gold Loan</Link></li>
                                <li><Link href="/services/group-loan" className="hover:text-blue-400">Group Loan</Link></li>
                            </ul>
                        </div>
