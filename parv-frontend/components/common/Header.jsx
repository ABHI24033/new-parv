...
export default function Header({ title, subTitle, img }) {
    ...
    return (
        <header className="relative bg-gradient-to-br from-blue-700 via-blue-800 to-indigo-900 text-white overflow-hidden py-8 md:py-10">

            {/* Background */}
            <div className="absolute top-0 right-0 -mr-20 -mt-20 w-72 h-72 bg-white/5 rounded-full blur-3xl pointer-events-none"></div>
            <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-56 h-56 bg-blue-400/10 rounded-full blur-3xl pointer-events-none"></div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex-1 space-y-3 text-center md:text-start">
                        ...
                        <div className="flex items-center gap-3 justify-center md:justify-start">
                            ...
                            <button
                                onClick={() => router.back()}
                                className="p-2 bg-white/10 hover:bg-white/20 rounded-lg transition backdrop-blur-sm"
                            >
